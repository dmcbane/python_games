...
BOARDWIDTH = int(sys.argv[1]) if len(
    sys.argv) > 1 else 10  # number of columns of icons
BOARDHEIGHT = int(sys.argv[2]) if len(
    sys.argv) > 1 else 7  # number of rows of icons
